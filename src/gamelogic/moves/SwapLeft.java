 ...
 * left of it.
 */
public class SwapLeft extends Swap {
   ...
   */
  public SwapLeft(List<Boundary> boundaries) {
    super(boundaries);
  }

  /**
   * Returns the correct coordinates for the spot we want to swap the cell into to the left of it.
   *
  ...
  public Coordinate getLocationToSwapWith(Agent currentAgent) {
    return currentAgent.getDirectLeftToBody().get(FIRST_CELL_IN_BODY);
  }
